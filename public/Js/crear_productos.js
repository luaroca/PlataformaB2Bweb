...
function precargarFormulario(producto) {
  ...
  // Previsualizar imágenes existentes (si manejas esa estructura)
...
if (imageInput) {
  imageInput.addEventListener('change', function () {
    ...
    document.querySelector('.file-input-text').textContent =
      `${this.files.length} imagen(es) seleccionadas`;
  });
}
...
form.addEventListener('submit', async (e) => {
  ...
  // Hacer imágenes opcionales: si no hay, borrar el campo
