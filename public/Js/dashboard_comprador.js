  ...
  try {
    ...
    if (res.ok && data.success) {
      ...
      if (usuario.rol === "distribuidor") {
        // Si es Distribuidor, ocultar botones de productos
        if (btnMisProductos) btnMisProductos.style.display = "none"
        if (btnCrearProducto) btnCrearProducto.style.display = "none"
      } else {
        // Si es Proveedor o Admin, mostrar botones
        if (btnMisProductos) btnMisProductos.style.display = "flex"
        if (btnCrearProducto) btnCrearProducto.style.display = "flex"
      }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (btnCrearProducto) {
    btnCrearProducto.addEventListener("click", () => {
      window.location.href = "../Html/crear_productos.html"
    })
  }
  ...
  if (btnMisProductos) {
    btnMisProductos.addEventListener("click", () => {
      window.location.href = "../Html/mis_productos.html"
    })
  }
